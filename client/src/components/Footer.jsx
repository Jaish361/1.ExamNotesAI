          ...
          style={{ transformStyle: "preserve-3d" }}>
            ...
            style={{ transform: "translateZ(20px)" }}>
              ...
              style={{ textShadow: "0 6px 18px rgba(0,0,0,0.4)" }}>
                 AI <span className="text-gray-400">SmartNotes</span>
              </span>

            </div>
            <p className="text-sm text-gray-300 max-w-sm">AI SmartNotes helps students create smart AI notes in seconds, revision material, diagrams, and printable PDFs using AI.</p>
 ...
 <div className='text-center'>
     ...
     <div className="my-6 h-px bg-white/10" />
      <p className='text-center text-xs text-gray-500'>
        © {new Date().getFullYear()} AI SmartNotes. All rights reserved.
     </p>
